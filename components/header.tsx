  ...
  return (
    <header className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-16 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-balance">Grow Smarter, Not Harder</h2>
        <p className="text-lg text-primary-foreground/90 max-w-2xl mx-auto text-balance">
          Get data-driven crop recommendations based on your soil and climate conditions. Make informed decisions for a
          bountiful harvest.
        </p>
      </div>
    </header>
